...
* [`AsyncOperationHandle.ReferenceCount`](xref:UnityEngine.ResourceManagement.AsyncOperations.AsyncOperationHandle.ReferenceCount): Returns the current reference count of the operation, or 0 if the handle is invalid. Useful for runtime memory and leak diagnostics.
