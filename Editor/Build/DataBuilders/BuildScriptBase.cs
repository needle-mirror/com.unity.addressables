...
namespace UnityEditor.AddressableAssets.Build.DataBuilders
{
    ...
    public class BuildScriptBase : ScriptableObject, IDataBuilder
    {
        ...
        /// </summary>
        /// <param name="tempPath">Temporary file path to use</param>
        /// <param name="contentStatePath">Path of the content state bin file</param>
        /// <param name="builderInput">Addressables builder input</param>
        /// <param name="addrResult">Resulting data generated by an Addressables build</param>
        ...
        /// </summary>
        /// <param name="a">The path to use</param>
        /// <returns>The final path for the library</returns>
