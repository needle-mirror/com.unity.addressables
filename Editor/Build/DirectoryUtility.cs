...
{
    /// <summary>
    /// Static helpers for common directory operations used during Addressables builds.
    /// Includes recursive copy, move, deletion, and path normalization utilities.
    /// </summary>
    public static class DirectoryUtility
    {
        ...
        /// <returns>The path with a trailing slash appended if it was missing.</returns>
