...
namespace UnityEditor.AddressableAssets.GUI
{
    internal class ProfileWindow : EditorWindow
    {
        ...
        void RenameVariable(AddressableAssetProfileSettings.ProfileIdData profileVariable, Rect displayRect)
        {
            try
            {
                PopupWindow.Show(displayRect, new ProfileRenameVariablePopup(displayRect, profileVariable, settings.profileSettings));
            }
            catch (ExitGUIException)
            {
                // Exception not being caught through OnGUI call
        ...
        void NewProfile()
        {
            ...
            {
                settings.profileSettings.AddProfile(uniqueProfileName, m_ProfileTreeView.GetSelectedProfile().id);
        ...
        class ProfileRenameVariablePopup : PopupWindowContent
        {
            ...
            internal AddressableAssetProfileSettings m_Settings;
            internal string m_NewName;
            public ProfileRenameVariablePopup(Rect fieldRect, AddressableAssetProfileSettings.ProfileIdData profileVariable, AddressableAssetProfileSettings settings)
            {
            ...
            public override void OnGUI(Rect windowRect)
            {
                ...
                if (hitEnter)
                {
                    ...
                    else if (m_NewName != m_Settings.GetUniqueProfileEntryName(m_NewName))
                    ...
                    {
                        m_ProfileVariable.SetName(m_NewName, m_Settings);
                        editorWindow.Close();
                    }
                }
                GUILayout.EndArea();
