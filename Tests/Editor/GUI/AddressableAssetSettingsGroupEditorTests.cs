...
namespace Tests.Editor.GUI
{
    public class AddressableAssetSettingsGroupEditorTests : AddressableAssetTestBase
    {
        ...
        public void SetUp()
        {
            Assert.AreEqual(2, Settings.groups.Count, "Expect only Default Group and Built In Data are initialized at test startup.");
        ...
        public void TestInitialSortIsSaved()
        {
            ...
            // initial sort hasn't been set
            var sortSettings = AddressableAssetGroupSortSettings.GetSettings();
            Assert.AreEqual(2, sortSettings.sortOrder.Length);
        }
        ...
        public void TestAdd_FromEmpty()
        {
            ...
            var builtInGroup = GetBuiltInGroup();
        ...
        public void TestAdd_ToSorted()
        {
            ...
            var sortSettings = AddressableAssetGroupSortSettings.GetSettings();
            Assert.AreEqual(sortSettings.sortOrder, new string[] {
                GetBuiltInGroup().Guid,
                GetGroupByName("Packed Assets5").Guid,
                GetDefaultGroup().Guid,
        ...
        public void TestMove_MultipleElements()
        {
            ...
            m_GroupEditor.m_EntryTree.HandleDragAndDropItems(draggedNodes, null, null, 4, true);
            sortSettings = AddressableAssetGroupSortSettings.GetSettings();
            Assert.AreEqual(sortSettings.sortOrder, new string[] {
                builtInGroup.Guid,
                defaultGroup.Guid,
        ...
        public void TestSort_Presorted()
        {
            ...
            // sort the groups
            m_GroupEditor.m_EntryTree.DeserializeState();
        ...
        AddressableAssetGroup GetDefaultGroup()
        {
            return GetGroupByName(AddressableAssetSettings.DefaultLocalGroupName);
        }

        AddressableAssetGroup GetBuiltInGroup()
        {
            return GetGroupByName(AddressableAssetSettings.PlayerDataGroupName);
        }
