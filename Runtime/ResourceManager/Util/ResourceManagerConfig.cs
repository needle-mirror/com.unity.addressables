        ...
        public Type Value
        {
            get
            {
                ...
                if (m_CachedType == null)
                    m_CachedType = TypeNameResolver.Resolve(m_AssemblyName, m_ClassName);
                return m_CachedType;
            }
            set
            {
                if (value != null)
                {
                    m_AssemblyName = TypeNameResolver.GetSimpleAssemblyName(value);
                    m_ClassName = TypeNameResolver.NormalizeTypeName(value);
                }
                else
                {
